...
<?php 
    if(isset($_GET['action']) && $_GET['action']== 'delete'){
        $id = (int)$_GET['id'];
        if($user->delete($id)){
            echo "<span class='delete'>Data delete succesfully </span>";
        }
    }
?>
...
<form action="" method="post">
 <table>
    ...
    <tr>
       <td>Department: </td>
        <td><input type="text" name="dep" placeholder=" Your depertment" required="1"/></td>
    </tr>
...
<section class="mainright">
  <table class="tblone">
    ...
    <tr>
        ...
        <td>
         <?php echo "<a href='worker.php?action=update&id=".$value['id']."'> Edit</a>" ?>
         ||
        <?php echo "<a href='worker.php?action=delete&id=".$value['id']."' onclick='return confirm(\"Are you sure want to delete data...\")'>Delete</a>" ?>
        </td>
    </tr>
  <?php } ?>
